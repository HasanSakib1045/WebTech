...
<body>
  ...
  <div class="about-section" id="aboutSection">
    <h2>About Valkyrie Pages</h2>
    <p>
      Valkyrie Pages is more than just a bookstore — it’s a community of readers, dreamers, and creators.
      Our mission is to bring the joy of reading to everyone, by offering timeless classics, modern bestsellers,
      and rare collections in one place.
    </p>
    <p>
      With every page you turn, we aim to inspire curiosity, spark imagination, and build knowledge.
      From students to book lovers, Valkyrie Pages is your trusted companion on the journey of stories.
    </p>
    <p>
      <strong>Our Values:</strong> Quality | Knowledge | Inspiration
    </p>
  </div>
  ...
  <div class="contact-section" id="contactSection">
    ...
    <p><strong>Email:</strong> support@valkyriepages.com</p>
    <p><strong>Phone:</strong> +880 1706677908</p>
    <div class="social-links">
      <a href="https://www.facebook.com/hasansakib89/">Facebook</a>
      <a href="#">Twitter</a>
      <a href="#">Instagram</a>
      <a href="https://www.linkedin.com/in/hasan-sakib-86a378324/">LinkedIn</a>
    </div>
